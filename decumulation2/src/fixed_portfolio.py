...
class FixedPortfolio:
    ...
    def get_const_scenario(self, rt, init_val, n_steps, schedule_mode):
        ...
        if abs(g - 1.0) < 1e-12:
            A = init_val / n_steps
            S_hat = init_val - A * np.arange(0, n_steps + 1)
        else:
    ...
    def run(self, rets, init_rt, init_val, contribution, withdrawal, const):
        ...
        rt = init_rt
        scenario, W = self.get_const_scenario(rt, init_val, n, schedule_mode="median")
